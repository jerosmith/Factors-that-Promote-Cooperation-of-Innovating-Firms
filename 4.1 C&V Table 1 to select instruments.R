...
for (v in var){
  ...
  p = df_coeff[v, 4]
  df_table1[i, "Cooperation.Logit"] = paste(round(df_coeff[v, "Estimate"], 4), asterisk(p))
  df_table1[i+1, "Cooperation.Logit"] = paste0("(", round(df_coeff[v, "Std. Error"], 4), ")")
}
...
for (v in var){
  ...
  i = which(df_table1$Variable==v)
  p = df_coeff[v, 4]
  df_table1[i, "Cooperation.OLS"] = paste(round(df_coeff[v, "Estimate"], 4), asterisk(p))
  df_table1[i+1, "Cooperation.OLS"] = paste0("(", round(df_coeff[v, "Std. Error"], 4), ")")
}
...
for (v in var){
  ...
  i = which(df_table1$Variable==v)
  p = df_coeff[v, 4]
  df_table1[i, "Incoming.Spillovers"] = paste(round(df_coeff[v, "Estimate"], 4), asterisk(p))
  df_table1[i+1, "Incoming.Spillovers"] = paste0("(", round(df_coeff[v, "Std. Error"], 4), ")")
}
...
for (v in var){
  ...
  i = which(df_table1$Variable==v)
  p = df_coeff[v, 4]
  df_table1[i, "Appropriability"] = paste(round(df_coeff[v, "Estimate"], 4), asterisk(p))
  df_table1[i+1, "Appropriability"] = paste0("(", round(df_coeff[v, "Std. Error"], 4), ")")
}
...
df_table1$Variable = gsub(" Scaled", "", df_table1$Variable, fixed = T)
