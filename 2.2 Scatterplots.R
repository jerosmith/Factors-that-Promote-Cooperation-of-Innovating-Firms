...
# 2. Make plots
variable = df_variables[!is.na(df_variables$Include.in.DB) & df_variables$Role.in.Dataset %in% c("Endogenous", "Exogenous") & df_variables$Data.Type=="Continuous", "Variable.R"]
for (v in variable){
  print(v)
